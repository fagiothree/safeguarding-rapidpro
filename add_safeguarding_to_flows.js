...
function process_wfr_node(node, flow, sg_keywords) {
    ...
    add_safeguarding_cat(node, enter_flow_node_uuid, sg_keywords);
...
function add_safeguarding_cat(wfr_node, dest_uuid, sg_keywords) {
    //create case object
    var sg_case = {};
